...
#define configTICK_RATE_HZ                      ( ( TickType_t ) 500 )		// 1000 - Default
#define configMAX_PRIORITIES                    ( ( uint32_t ) 5 )			// 5 - Default
#define configMINIMAL_STACK_SIZE                ( ( uint16_t ) 70 )
/* configTOTAL_HEAP_SIZE is not used when heap_3.c is used. */
#define configTOTAL_HEAP_SIZE                   ( ( size_t ) ( 8000 ) )		// 15000 Default
